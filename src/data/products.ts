...
const PRODUCT_IMAGES = import.meta.glob("../assets/products/*.jpg", {
  eager: true,
  query: "?url",
  import: "default",
...
export const products: Product[] = [
  ...
  ...mk("mango", [
    [
      ...
      "বারি-৪ আম",
      720,
      "photo-1605027990121-cbae9e0642db",
      "বারোমাসি, দেরিতে পাকা মিষ্টি আম।",
    ],
    [
      "langra-mango",
      "ল্যাংড়া আম",
      690,
      "photo-1591735026282-bb24fd6c0451",
      "ঐতিহ্যবাহী সুগন্ধি ল্যাংড়া জাত।",
    ],
    ...
    [
      ...
      2500,
      "photo-1605027990121-cbae9e0642db",
      "জাপানের বিশ্বখ্যাত প্রিমিয়াম আম।",
    ],
  ]),
  // ── More Citrus (8) ──
  ...mk("citrus", [
    ...
    [
      ...
      "উচ্চ ফলনশীল দেশি জাত।",
    ],
    [
      "grape-fruit",
      "গ্রেপফ্রুট",
      620,
      "photo-1591287083773-9a52902db5f0",
      "গোলাপি শাঁসের সাইট্রাস।",
    ],
    [
      "nagpur-orange",
      "নাগপুর কমলা",
  ...
  ...mk("guava", [
    [
      ...
      "বারি পেয়ারা-২",
      320,
      "photo-1633380110125-f6e685676160",
      "দেশি উচ্চ ফলনশীল জাত।",
    ],
    [
      "seedless-guava",
      "বীজহীন পেয়ারা",
  ...
  ...mk("litchi", [
    [
      ...
      "চায়না-৩ লিচু",
      950,
      "photo-1629828874514-e1ad6f1de1f5",
      "জনপ্রিয় মিষ্টি লিচু।",
    ],
    [
      "bombai-litchi",
      "বোম্বাই লিচু",
  ...
  ...mk("tropical", [
    [
      ...
      "সাদা ড্রাগন ফল",
      480,
      "photo-1610917040803-1fccf9623064",
      "সাদা শাঁসের ড্রাগন।",
    ],
    [
      "yellow-dragon-fruit",
    ...
    [
      ...
      1850,
      "photo-1610917040803-1fccf9623064",
      "‘ফলের রানী’ — দক্ষিণ-পূর্ব এশিয়ার দুর্লভ।",
    ],
  ...
  ...mk("aquatic", [
    ...
    [
      ...
      150,
      "photo-1490750967868-88aa4486c946",
      "বেগুনি ফুলের জলজ গাছ।",
    ],
    ["papyrus", "প্যাপিরাস", 320, "photo-1490750967868-88aa4486c946", "মিশরীয় জলজ ঘাস।"],
  ]),
];

function mk(category: string, rows: [string, string, number, string, string][]): Product[] {
...
export const bestsellers = () => products.filter((p) => p.badges?.includes("বেস্ট সেলার"));

export const newArrivals = () => products.filter((p) => p.badges?.includes("নতুন"));
