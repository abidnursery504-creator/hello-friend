...
export const catalogKeys = {
  ...
  defaultDeliveryCharge: () => ["settings", "default-delivery-charge"] as const,
};
...
export const useTestimonials = () =>
  useQuery({
    queryKey: catalogKeys.testimonials(),
...
export const useBlogPost = (slug: string) =>
  useQuery({
    queryKey: catalogKeys.blogPost(slug),
...
export const useDefaultDeliveryCharge = () =>
  useQuery({
    queryKey: catalogKeys.defaultDeliveryCharge(),
    queryFn: fetchDefaultDeliveryCharge,
    staleTime: 60_000,
  });
...
export const ensureLandingPage = (qc: QueryClient, slug: string) =>
  qc.ensureQueryData({
    queryKey: catalogKeys.landingPage(slug),
...
export const ensureDefaultDeliveryCharge = (qc: QueryClient) =>
  qc.ensureQueryData({
    queryKey: catalogKeys.defaultDeliveryCharge(),
    queryFn: fetchDefaultDeliveryCharge,
  });
